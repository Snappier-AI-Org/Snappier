...
export const InstagramCommentTriggerDialog = ({
  ...
  }, [nodeData?.credentialId, nodeData?.postId, nodeData?.keywords, nodeData?.keywordMatchMode]);
  ...
  const handlePostIdChange = (value: string) => {
    setPostId(value);
    onNodeDataChange?.({ ...nodeData, postId: value });
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Instagram Comment Trigger Configuration</DialogTitle>
          <DialogDescription>
            Configure this trigger to run your workflow when an Instagram comment
            is posted.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-4 flex flex-col gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter Instagram post ID to monitor..."
            />
          ...
          <div className="rounded-lg border bg-muted/50 p-4 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              When a comment is posted, you can access this data in subsequent
              nodes:
            </p>
