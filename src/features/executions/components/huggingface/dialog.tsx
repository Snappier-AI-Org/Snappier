...
export const HuggingFaceDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defaultValues.model || "mistralai/Mistral-7B-Instruct-v0.3",
  ...
  const watchVariableName = trimmedVariableName || "myHuggingFace";
  ...
  return (
    ...
    >
      <ConfigDialogHeader>
        <ConfigDialogTitle>Hugging Face Configuration</ConfigDialogTitle>
        <ConfigDialogDescription>
          Configure the AI model and prompts. Hugging Face provides access to thousands of open-source models.
        </ConfigDialogDescription>
      </ConfigDialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <CredentialSelect
                        type={CredentialType.HUGGINGFACE}
                        value={field.value}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        value={field.value || "mistralai/Mistral-7B-Instruct-v0.3"}
                    ...
                    <FormDescription>
                      Choose the Hugging Face model to use for this node.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
