...
export const GroqDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defaultValues.model || "llama-3.3-70b-versatile",
  ...
  const watchVariableName = trimmedVariableName || "myGroq";
  ...
  return (
    ...
    >
      <ConfigDialogHeader>
        <ConfigDialogTitle>Groq Configuration</ConfigDialogTitle>
        <ConfigDialogDescription>
          Configure the AI model and prompts for this node. Groq provides ultra-fast inference for open-source LLMs.
        </ConfigDialogDescription>
      </ConfigDialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        value={field.value || "llama-3.3-70b-versatile"}
                    ...
                    <FormDescription>
                      Choose the Groq model to use for this node.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
