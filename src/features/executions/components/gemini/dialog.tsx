...
export const GeminiDialog = ({
  ...
  const watchVariableName = trimmedVariableName || "myGemini";
  ...
  return (
    ...
    >
      <ConfigDialogHeader>
        <ConfigDialogTitle>Gemini Configuration</ConfigDialogTitle>
        <ConfigDialogDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        value={field.value || "gemini-2.0-flash"}
                    ...
                    <FormDescription>
                      Choose the Gemini model to use for this node.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
