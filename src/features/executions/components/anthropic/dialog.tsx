...
export const AnthropicDialog = ({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      model: defaultValues.model || "claude-3-5-haiku-20241022",
  ...
  const watchVariableName = trimmedVariableName || "myAnthropic";
  ...
  return (
    ...
    >
      <ConfigDialogHeader>
        <ConfigDialogTitle>Anthropic Configuration</ConfigDialogTitle>
        <ConfigDialogDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        value={field.value || "claude-3-5-haiku-20241022"}
                    ...
                    <FormDescription>
                      Choose the Anthropic model to use for this node.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
