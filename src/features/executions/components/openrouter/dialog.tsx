...
export const OpenRouterDialog = ({
  ...
  const watchVariableName = trimmedVariableName || "myOpenRouter";
  ...
  return (
    ...
    >
      <ConfigDialogHeader>
        <ConfigDialogTitle>OpenRouter Configuration</ConfigDialogTitle>
        <ConfigDialogDescription>
          Configure the AI model and prompts for this node. OpenRouter provides access to 100+ AI models from multiple providers through a single API.
        </ConfigDialogDescription>
      </ConfigDialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        value={field.value || "openai/gpt-4o-mini"}
                    ...
                    <FormDescription>
                      Choose the AI model to use. OpenRouter gives you access to models from OpenAI, Anthropic, Google, Meta, and more.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
